...
--
-- 前提: マイグレーション 0001〜0038 適用済み・games に OVERWATCH が seed 済み。
--
-- スコアのスケールについて（2026-08 エメラルド追加・0038 対応）:
--   ランク体系が 40段階 → 45段階 になったため、本 seed の応募スコアを一律 +2 して
--   再分配した（旧 15〜30 → 新 17〜32）。45段階では P=16-20 / E=21-25 / D=26-30 /
--   M=31-35 なので、エメラルド帯を中心にプラチナ〜マスターへ分布する。
--   team_score_cap は 26 → 28（=ダイヤ3相当）。全12チームの出場メンバー平均
--   （最大 27.6）が上限内に収まる値を選んでいる。
--   既存 DB に対しては supabase/prod_seed_rank_emerald_rescale.sql を流す。
...
begin
  ...
  values (
    'e15d9961-38a7-4288-bf04-5e2c890f08b4', null, v_game_id, v_org_id, 'Matchpoint Open Vol.1', null, 'event-mpvbcd', 'published', 12, 12, '2026-07-29T06:32:00+00:00', '2026-07-22T06:32:00+00:00', 'individual', 'organizer', false, true, true, true, true, 3, 1, 2, 3, 0, 28, null, true, null, 'exclude', true, 3, 1, 0, array['head_to_head','map_diff','potg'], 3, 3, true, 'のり', 'round_robin_then_tournament'
  )
  on conflict (id) do nothing;
end $$;
...
insert into public.registrations (id, event_id, user_id, preferred_role, assigned_role, wants_matching, status, individual_score, final_score, score_breakdown, organizer_override_score, preferred_role_1, preferred_role_2, preferred_role_3, display_name) values
  ('e1ac1a87-670b-4489-ae02-c9a6df6c3a19', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '93be5acd-fcd6-41f9-ab5a-f5bc1f855c3c', 'tank', null, null, 'approved', 20, 20, '{"demo":true}'::jsonb, null, 'tank', 'dps', 'support', 'FlickMaster'),
  ('d9194055-4231-4fb1-a311-deddea787e07', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'a3cf3a26-fcab-4b97-b44d-4641d1d9468e', 'tank', null, null, 'approved', 25, 25, '{"demo":true}'::jsonb, null, 'tank', 'dps', 'support', 'Sana'),
  ('59ae8af0-bd10-480c-985a-59e693983857', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '255729b5-8fd6-4e8e-a84a-52ba39017c82', 'tank', null, null, 'approved', 27, 27, '{"demo":true}'::jsonb, null, 'tank', 'dps', 'support', 'Frost'),
  ('d32fd8f5-5bfd-40a7-b41f-a4916de600ca', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '5b75ba8c-2316-4f57-a34a-67c3718acd09', 'tank', null, null, 'approved', 27, 27, '{"demo":true}'::jsonb, null, 'tank', 'dps', 'support', 'Kazuki'),
  ('d8d3b374-ffe2-4ef7-bea2-81d3a299bfbb', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '7cf6c483-31e3-4621-beeb-326a1d76cba3', 'tank', null, null, 'approved', 26, 26, '{"demo":true}'::jsonb, null, 'tank', 'dps', 'support', 'Nova'),
  ('3ba9bd6a-0424-4afd-ab45-66d0241269ca', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '40e7e19e-011f-4d30-95d5-6aa43b741b08', 'tank', null, null, 'approved', 19, 19, '{"demo":true}'::jsonb, null, 'tank', 'dps', 'support', 'Echo'),
  ('16220459-7021-4f19-aba9-d9c40edaf6bc', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'b863f1af-32e8-494d-9852-dd9c696958cd', 'tank', null, null, 'approved', 24, 24, '{"demo":true}'::jsonb, null, 'tank', 'dps', 'support', 'Onyx'),
  ('e522f120-1d67-4677-8638-91ff2426b844', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'f32c042f-2db6-463f-acc2-7d5e53f11579', 'tank', null, null, 'approved', 20, 20, '{"demo":true}'::jsonb, null, 'tank', 'dps', 'support', 'Yuki'),
  ('2d01c829-3c0d-4ad3-8a89-658ba864cd63', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'fe73b519-6941-4318-a841-2be5c8ece050', 'tank', null, null, 'approved', 23, 23, '{"demo":true}'::jsonb, null, 'tank', 'dps', 'support', 'Nao'),
  ('e974bc75-0757-4180-9933-11b2a5b2e54f', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '8bfc99c8-5153-4e60-8e86-28d171635840', 'tank', null, null, 'approved', 25, 25, '{"demo":true}'::jsonb, null, 'tank', 'dps', 'support', 'かえで'),
  ('c7b62221-3c7d-4d97-b655-83d759b13af7', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '6558e54e-e9c6-4da0-9bc9-ceeac15a97b0', 'tank', null, null, 'approved', 23, 23, '{"demo":true}'::jsonb, null, 'tank', 'dps', 'support', 'Kaito'),
  ('04e29c2f-14a9-4107-a441-8a9a5b6e7adf', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'b521dc64-1a14-4b7c-bb4d-225274e5662f', 'tank', null, null, 'approved', 24, 24, '{"demo":true}'::jsonb, null, 'tank', 'dps', 'support', 'Sora'),
  ('4a91553e-f41a-4434-8d27-4bfb19146d55', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'a50cb551-3c34-4088-8bb7-067a59ac5ad4', 'tank', null, null, 'approved', 23, 23, '{"demo":true}'::jsonb, null, 'tank', 'dps', 'support', 'Tsubasa'),
  ('d11e94f6-4f9c-4a28-9a7f-cbe94b86451b', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'e4bb479e-d751-4c4e-9a47-543f88b0b950', 'tank', null, null, 'approved', 22, 22, '{"demo":true}'::jsonb, null, 'tank', 'dps', 'support', 'Cipher'),
  ('2bd348e4-6296-4b64-b09e-390fd383a8e2', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '32b8863d-3a2c-464f-b0d3-d442d70922f3', 'dps', null, null, 'approved', 17, 17, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'Diamond_Dust'),
  ('3a7cf469-7dd7-4abd-ab2f-0fdcd357dda4', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '234fb8d6-5f53-444c-8b39-f7711a9ef4a8', 'dps', null, null, 'approved', 25, 25, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'Aki'),
  ('92858b87-e4d9-45ce-8da5-bdea6ae40acd', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '5c79fadb-9f5f-45e1-a6e0-20b279ac2d76', 'dps', null, null, 'approved', 27, 27, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'xX_Sniper_Xx'),
  ('4227fda8-ba8c-42e4-9957-18f5e4704f64', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '241f2ea4-a782-410d-a92f-d69074b6d211', 'dps', null, null, 'approved', 24, 24, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'Rei'),
  ('ee208d0b-b7d0-4fd7-97b6-25b84f01beb5', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'a6548218-ef6a-4d67-8f2f-f4f6ce928c82', 'dps', null, null, 'approved', 22, 22, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'Vortex'),
  ('a5048aaf-b733-4c9b-833d-96d9976d564c', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '84fd7b89-c0b4-4f25-816c-36c5a9aa5341', 'dps', null, null, 'approved', 28, 28, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'Riku'),
  ('6643f330-cc58-4171-be5a-0ce49cf8c8f1', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '7c157096-8bd8-4c77-8ca2-8ea752c7a380', 'dps', null, null, 'approved', 23, 23, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'つばき'),
  ('f40d1231-2de1-4098-894a-e60d7b662343', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '51ab11cb-d724-4d0f-9507-7639cc53ae46', 'dps', null, null, 'approved', 25, 25, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'VoidWalker'),
  ('58f3bf94-068b-4d2e-b560-97b1257ea10c', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '5be0fec2-d5e5-42e7-b3fd-e250f3107dda', 'dps', null, null, 'approved', 27, 27, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'ShadowFox'),
  ('9eaafe6f-b515-4a35-bc55-7672b187f6ff', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '1c210e60-2105-4a6d-b442-5cd4cc8e83f4', 'dps', null, null, 'approved', 22, 22, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'Ghost_JP'),
  ('b01578ca-e7d5-4364-975b-ba88c542a506', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'a6515b54-5f93-4cae-82ce-80e3c9748118', 'dps', null, null, 'approved', 25, 25, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'Blaze'),
  ('594189ac-47fb-4b9a-8ecf-b17e7a47eeb7', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '7328858b-a956-46b5-9a4b-004cab29cbc8', 'dps', null, null, 'approved', 23, 23, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'れん'),
  ('ae34a973-92fd-4713-b5a5-2d94d049368c', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'a95fbf1a-e01e-4393-8a36-89373e69567d', 'dps', null, null, 'approved', 23, 23, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'TankLord'),
  ('662707fe-a210-4f03-9107-a40e228860e3', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '7932df2a-76fe-453c-b04b-e326458f2692', 'dps', null, null, 'approved', 29, 29, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'はやて'),
  ('22beb0b3-8926-432c-94fa-5c3dcd9e622b', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '9b1b0653-ebb7-4292-9647-2a32ef439362', 'dps', null, null, 'approved', 19, 19, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'Kenji'),
  ('475ad81a-f138-4d3b-9a07-0ff4046dd9dc', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '4a9e26be-da89-4a85-9d29-dd1fe08e1458', 'dps', null, null, 'approved', 31, 31, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'Emi'),
  ('5a75802e-f00c-4b45-8c24-9c51580e09e4', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'c1d60351-904a-4417-bad7-28764e754582', 'dps', null, null, 'approved', 24, 24, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'Haruto'),
  ('ba192bde-11df-4475-9652-c65131091de6', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '72ccadc1-e18b-4a50-9899-9ae6da7e215f', 'dps', null, null, 'approved', 26, 26, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'Shota'),
  ('08eae947-e986-45b2-b6eb-7715da7692ed', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '9e50387e-017a-414b-945e-1d28f6f50fdf', 'dps', null, null, 'approved', 26, 26, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'JadeDragon'),
  ('d6f2dd69-3117-491a-835d-f7ad9166b278', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '27adaa67-c251-4531-bc89-34680a5b5c38', 'dps', null, null, 'approved', 17, 17, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'Subaru'),
  ('2d7f061c-c757-4855-b24b-62a4391c2c6d', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '64d2afbc-9d4b-4d26-9602-ba941d900585', 'dps', null, null, 'approved', 28, 28, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'みなと'),
  ('bd1832c3-d5bd-4e97-a579-8a3790dfda7e', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '6577148a-8da9-492a-9f1b-3d1cf05cb27f', 'dps', null, null, 'approved', 31, 31, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'Minato_JP'),
  ('85ab19af-659b-4742-91d2-135b27ade674', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'db11dc00-8c99-40a4-9ad2-a24e08bd0bc8', 'dps', null, null, 'approved', 22, 22, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'Reaper77'),
  ('e42765f0-4739-4f67-ada2-dc1d7564b5f5', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'c8959d4a-cb5a-4fdf-a008-1d7384c8697f', 'dps', null, null, 'approved', 29, 29, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'Aim_God'),
  ('7b930a2f-d51e-4186-9b1f-474384ae60bc', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '6de90e6b-cfea-4bbc-817b-49610bd371fa', 'dps', null, null, 'approved', 25, 25, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'HealBot'),
  ('e64efb85-6b16-4a99-951c-b94c427f0e3b', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'd5e664cc-513a-4667-9c1b-93e09922eb85', 'dps', null, null, 'approved', 30, 30, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'そうた'),
  ('4a28c8c9-a059-4690-b97e-fdae52b0821c', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'f13ed86c-80c3-43cf-8e39-ce703093714b', 'dps', null, null, 'approved', 21, 21, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'SilverWolf'),
  ('e20a2eef-d042-4fad-b83b-57043dece8db', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '30a882db-a2a1-4606-b5e9-5f00f3677b6d', 'dps', null, null, 'approved', 24, 24, '{"demo":true}'::jsonb, null, 'dps', 'support', 'tank', 'Aoi'),
  ('c3430d0f-38db-4554-b33f-ff243b198360', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '049e134c-4bc9-4601-b7e4-374e0fa45cca', 'support', null, null, 'approved', 22, 22, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'Hinata_OW'),
  ('93df5f2a-06d6-4e52-9951-5971c46d5e09', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '1ca7a7e6-34b7-4653-b8a4-a73bda8746da', 'support', null, null, 'approved', 32, 32, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'ProGamerJP'),
  ('c5c2de52-9c84-4d6e-8317-c4f0755e8d92', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '5dec505a-0609-4340-85f4-a0297e4f5c59', 'support', null, null, 'approved', 30, 30, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'Luna'),
  ('82f6f550-7eb0-475f-98f4-a7217a42f528', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'b4c425ef-04ba-4544-a6dd-0245c227688f', 'support', null, null, 'approved', 32, 32, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'Daiki'),
  ('0397b1fa-2a9f-49b1-8d96-77a124537f3d', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'fba13afa-020d-424b-9a88-375eaab26276', 'support', null, null, 'approved', 20, 20, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'しずく'),
  ('745f9c47-e88f-4d28-a1c0-5933608ba7a7', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'f53d95b7-8896-49f3-a6f7-87f1eae27332', 'support', null, null, 'approved', 17, 17, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'ひなた'),
  ('1c0c8383-ee41-4d4f-bd4a-7810609cbb4a', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'e6c9f565-c2c0-455c-b3a7-8bb925cf4da4', 'support', null, null, 'approved', 26, 26, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'GoldenEye'),
  ('4cb84fc5-d94d-46ef-8c73-23bbe3358ca3', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '75f72d96-4b08-4305-bf03-88649166c60e', 'support', null, null, 'approved', 32, 32, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'HeadshotHiro'),
  ('ebb318f5-607b-430d-8bf9-08b06e026af2', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'a3a4d63d-2338-41fc-bf05-4e41fa5a5c63', 'support', null, null, 'approved', 29, 29, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'Sena'),
  ('616ad475-c9ba-4749-bbd2-a60e0faa19cc', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'dd15da2a-f8bb-4f3b-9050-6d3fd45c00f7', 'support', null, null, 'approved', 28, 28, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'Rio'),
  ('644d64db-6ad2-4ae2-9c10-ae22aecb0727', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '18976b3c-0415-4a60-bc84-8e579c175076', 'support', null, null, 'approved', 19, 19, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'SmurfKiller'),
  ('c106ddcc-47e8-4a56-9dc8-1d75436d5650', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '2fdd3bd9-04f1-40fb-93b6-94802f5e3767', 'support', null, null, 'approved', 22, 22, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'CrimsonEdge'),
  ('1a92835c-ad36-4395-9512-964c1691aa13', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '5801aba8-a1f2-4a42-9215-afe0beadfdfe', 'support', null, null, 'approved', 26, 26, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'Ren'),
  ('542be131-ab40-4a85-b859-de7c33c9747e', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '336c9594-7c37-42ad-a547-eff2e65cb943', 'support', null, null, 'approved', 30, 30, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'ゆうき'),
  ('3d9fa47c-e3ac-4c09-9669-ed8d2e959e7e', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'd48a6ec5-9c14-4cdc-9693-4e04795f7934', 'support', null, null, 'approved', 27, 27, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'Yuto'),
  ('eaa49d04-5f39-4be0-ae53-e718bc84a4c7', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '0704ae38-a038-45d0-a29c-c0562725be36', 'support', null, null, 'approved', 28, 28, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'Ryota'),
  ('7264ed69-e7f9-4292-aefa-47b1415849ed', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '8953e988-0713-4e8a-91ac-19b0eee0f9ad', 'support', null, null, 'approved', 25, 25, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'NightRaven'),
  ('0d8a26fb-ea9d-41af-a39c-135511167cb7', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '0b94b1b8-b746-4602-a882-3a0e2d6d73c1', 'support', null, null, 'approved', 28, 28, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'Zephyr'),
  ('8b304a34-5bde-4f55-953f-87206ccb558b', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'b61aa3a0-075d-4bfb-b53f-68fc03d59088', 'support', null, null, 'approved', 26, 26, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'Takumi'),
  ('2d88a498-7fc3-47cd-bf10-754187e906de', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'a46d6edb-29f9-45f0-8563-30771e7e45c6', 'support', null, null, 'approved', 21, 21, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'Haru'),
  ('925f327e-b0fd-4131-a4c1-d41fec0f45d3', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '073f6865-f8b3-42a7-94e3-c0637e90306b', 'support', null, null, 'approved', 24, 24, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'AzureSky'),
  ('7c48e26e-8ba8-43b4-80cd-f23ff03c3754', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '14bf7d31-36ca-433e-9c7d-0de500b441a0', 'support', null, null, 'approved', 25, 25, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'IronWill'),
  ('6e4142b7-adfc-4176-811f-23f8158d80eb', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'aa3f667e-3126-4700-af42-ac18cf868d8b', 'support', null, null, 'approved', 31, 31, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'OneTrick'),
  ('cb392b35-bfed-4ad7-88da-8550db7b4e39', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '5ea9c23b-b48c-4870-a4c3-07c8aaaa8f4c', 'support', null, null, 'approved', 21, 21, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'Mei'),
  ('44b8a39e-22c4-49ed-abb3-65dd331456fe', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', 'adb42f9c-993c-436c-ad4e-f456ea0741b6', 'support', null, null, 'approved', 17, 17, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'Itsuki'),
  ('c056d716-f4f0-4304-9610-055f88a49d6a', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '6b44582f-33bb-4068-8c4b-7a7a1467be86', 'support', null, null, 'approved', 27, 27, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'ClutchKing'),
  ('513e15ee-96ed-4b8a-84d3-4c43a33156e0', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '4a317b41-afc6-4271-bcb6-0b7a301d5a3e', 'support', null, null, 'approved', 25, 25, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'たける'),
  ('14fc9f5f-a8eb-410a-bda2-104ab18eda00', 'e15d9961-38a7-4288-bf04-5e2c890f08b4', '7605e2a4-c0c3-4e89-9fc8-694100009f84', 'support', null, null, 'approved', 28, 28, '{"demo":true}'::jsonb, null, 'support', 'tank', 'dps', 'Kira')
on conflict (id) do nothing;
